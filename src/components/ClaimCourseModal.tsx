...
export default function ClaimCourseModal({
  ...
  } = api.youtubeCourses.addClaimCourseRequest.useMutation();
              ...
              >
                <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-2xl bg-neutral-800 p-4 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    ...
                    <button
                      type="submit"
                      className="flex w-full items-center justify-center gap-1 rounded-lg bg-pink-500 px-3 py-2  text-center font-bold tracking-wider duration-150 hover:bg-pink-600"
                    >
