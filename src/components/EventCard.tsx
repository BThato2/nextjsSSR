...
const EventCardId = ({ eventId, manage }: Props) => {
  ...
  return (
    <Link
      ...
      className={`flex w-full max-w-2xl cursor-pointer flex-col justify-center gap-4 rounded-xl p-3 backdrop-blur transition-all hover:bg-neutral-700/50 xs:flex-row xs:items-center`}
    >
      {event?.datetime && (
...
export const EventCard = ({
  ...
  return (
    <Link
      ...
      className={`relative flex w-full max-w-2xl cursor-pointer flex-col justify-center gap-4 rounded-xl p-3 backdrop-blur-sm transition-all duration-300 hover:bg-neutral-700/60 xs:flex-row xs:items-center ${
