    ...
    >
      ...
      <div className="flex w-full flex-col md:flex-row">
        ...
        <button
          ...
          className={`group inline-flex items-center justify-center gap-1 rounded-xl px-[1.5rem]  py-2  text-center font-medium text-neutral-200 transition-all duration-300 hover:underline disabled:text-neutral-300`}
          type="submit"
        >
