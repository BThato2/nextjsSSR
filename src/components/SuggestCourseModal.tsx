                  ...
                  >
                    ...
                    <div className="relative mt-4 flex w-full items-center">
                      <input
                        ...
                        className="peer w-full gap-1 rounded-lg bg-pink-500/10 px-8 py-2 text-sm font-medium text-neutral-200   outline outline-2 outline-pink-500/40 backdrop-blur-sm transition-all duration-300 placeholder:text-neutral-200/50 hover:outline-pink-500/80 focus:outline-pink-500"
                      />
