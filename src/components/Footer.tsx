...
export default function Footer() {
  return (
    <footer className="display mt-12 flex w-full justify-center bg-neutral-950 px-4 py-8">
      <div className="flex w-full max-w-6xl flex-col items-center gap-2 divide-y divide-neutral-800">
        <div className="mb-4 flex w-full items-center justify-between gap-4 sm:items-start">
          <div className="flex flex-col items-start gap-1">
            ...
            <div className="mb-2 ml-3 text-sm text-neutral-400 sm:block">
              Created by{" "}
        ...
        <div>
          <div className="mb-3 flex flex-col items-center gap-2 pt-5 sm:flex-row sm:gap-8">
            <Link
