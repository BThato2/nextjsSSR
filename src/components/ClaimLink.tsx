...
export function ClaimLink({ profile }: { profile?: string }) {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="group absolute right-1 flex items-center gap-2 rounded-full bg-pink-600 p-2 px-4 text-xs font-bold text-neutral-200 duration-300 hover:bg-pink-700"
      >
        <span className="mr-2 hidden md:block">Claim Now</span>
        {makeCreatorLoading ? (
          <div>
            <Loader white />
          </div>
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="group flex h-[512/14px] items-center gap-2 rounded-2xl border border-pink-500 bg-pink-500 px-6 py-2 font-bold text-neutral-200 shadow-[-2px_3px_0px_0px] shadow-pink-500/60 duration-300 hover:shadow-[-4px_7px_0px_0px] hover:shadow-pink-500/60 active:shadow-[-2px_3px_0px_0px] active:shadow-pink-500/60 disabled:cursor-not-allowed disabled:border-pink-500/80 disabled:bg-pink-500/50 disabled:text-neutral-200/70 disabled:hover:shadow-[-2px_3px_0px_0px] disabled:hover:shadow-pink-500/60"
      >
