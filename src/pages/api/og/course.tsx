    ...
    return new ImageResponse(
      (
        <div tw="relative bg-neutral-800 font-bold w-full h-full flex flex-col items-center">
          ...
          >
            <img src={thumbnail ?? ""} alt={title ?? ""} tw="w-full absolute" />
          </div>

          <h1 tw="tracking-wide max-h-[2rem] overflow-hidden font-black text-3xl max-w-4xl text-neutral-200 text-center uppercase">
            {title}
          </h1>
