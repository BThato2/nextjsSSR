...
import { ChartBarSquareIcon as ChartBarSquareIconO } from "@heroicons/react/24/outline";
import ChartBarSquareIcon from "@heroicons/react/20/solid/ChartBarSquareIcon";
import {
...
function DashboardLayoutR({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    if (router.pathname === "/creator/dashbgoard")
      ...
      <div className="flex h-full w-full items-start">
        <div className="fixed z-20 flex h-full flex-col items-center justify-start gap-8 bg-neutral-900 pb-12 pt-8 text-neutral-400 md:w-60">
          {creator ? (
            ...
            <>
              <div className="flex w-full justify-center p-0 md:p-4">
                <div className="flex w-full justify-center rounded-xl p-0 duration-300 md:animate-pulse md:bg-neutral-800 md:p-2">
          ...
          <div className="flex w-full flex-grow flex-col items-center">
            ...
            <Link
              ...
              className={`group flex h-12 w-full cursor-pointer grid-cols-3 gap-3 text-xl transition duration-200 ease-linear hover:bg-neutral-700/50 ${
                pathname && pathname === "/creator/dashboard/analytics"
                  ? "text-pink-500"
                  : "hover:text-neutral-200"
              }`}
            >
