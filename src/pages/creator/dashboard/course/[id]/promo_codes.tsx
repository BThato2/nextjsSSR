...
const CoursePromoCodes = () => {
  ...
  const { data: promoCodess, isLoading: promosLoading } =
    api.coursePromoCodes.getAll.useQuery({ courseId: id });
...
const PromoCodeCard = ({
  ...
  const { mutateAsync: editActiveMutation } =
    api.coursePromoCodes.editActive.useMutation();
          ...
          <Switch
            ...
            onClick={() => {
              ...
              void editActiveMutation(
                ...
                {
                  onSuccess: () => {
                    void ctx.coursePromoCodes.getAll.invalidate();
                  },
                },
              );
            }}
...
export function DeletePromoCodeModal({
  ...
  const { mutateAsync: deleteMutation, isLoading } =
    api.coursePromoCodes.delete.useMutation();
  const ctx = api.useContext();
