...
const Index = () => {
  ...
  const { data: playlists } = api.youTubeAPI.searchYoutubePlaylists.useQuery({
    searchQuery: debouncedQuery,
  });

  const { data: playlistData, isLoading: playlistLoading } =
    api.youTubeAPI.getYoutubePlaylist.useQuery({
      playlistId,
    });
  ...
  } = api.youtubeCourses.import.useMutation();
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="relative flex items-center">
            <input
              ...
              className="peer w-full gap-1 rounded-lg bg-pink-500/10 px-3 py-2 pl-8 font-medium text-neutral-200 outline outline-2 outline-pink-500/40 backdrop-blur-sm transition-all duration-300 placeholder:text-neutral-200/50 hover:outline-pink-500/80 focus:outline-pink-500"
            />
