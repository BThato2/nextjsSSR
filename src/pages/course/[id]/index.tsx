...
const Index = ({ courseId }: Props) => {
  ...
  const { data: isEnrolled, isLoading: isEnrolledLoading } =
    api.courseEnrollment.isEnrolled.useQuery({ courseId });
                ...
                <>
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className={`group my-1 inline-flex items-center justify-center gap-1 rounded-xl bg-pink-500 px-6 py-1  text-center font-medium text-neutral-200 transition-all duration-300 hover:bg-pink-600`}
                    >
                      {enrollLoading ? (
                        <div>
                          <Loader white />
                    ...
                    <button
                      ...
                      className={`group my-1 inline-flex items-center justify-center gap-1 rounded-xl border border-pink-500 px-6  py-1 text-center font-medium text-pink-500 transition-all duration-300 hover:border-pink-600 hover:bg-pink-600/10 hover:text-pink-600`}
                    >
                      <>
                        <PlayIcon className="w-4" />
                        <span>Preview</span>
